...
Examples:
    ...
    quick_validate.py ~/.local/share/agent-skills/my-skill

Relative skill names resolve under $AGENT_SKILLS_HOME, defaulting to ~/.local/share/agent-skills/.
"""
...
SKILLS_BASE_PATH = Path(
    os.environ.get("AGENT_SKILLS_HOME", "~/.local/share/agent-skills")
).expanduser().resolve()
...
if __name__ == "__main__":
    if len(sys.argv) != 2:
        ...
        print("  quick_validate.py ~/.local/share/agent-skills/my-skill")
