---
name: skill-creator
description: Use when creating or updating an agent skill with reusable instructions, scripts, references, templates, progressive disclosure, validation, and a portable package structure.
---
...
- Creates the skill directory under `$AGENT_SKILLS_HOME/<skill-name>/`, defaulting to `~/.local/share/agent-skills/<skill-name>/`
...
```
$AGENT_SKILLS_HOME/{skill-name}/SKILL.md
```

The system will automatically:

1. Detect the selected skill package’s `SKILL.md` path
