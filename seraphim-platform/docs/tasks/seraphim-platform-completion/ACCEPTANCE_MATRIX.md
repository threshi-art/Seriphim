...
| G1-02 | Storage resolver migrates bridge/legacy-agent durable state below LOCALAPPDATA, rejects Git/repository/workspace/OneDrive production paths, and accepts memory/temp tests |
...
| G1-12 | Audit verifier detects mutation, deletion, insertion, reordering, and recomputed suffixes through a trusted external signed anchor                                        |
...
| G2-06 | Approved write is hard-disabled by default, operator-authorized, contained, exact, atomic, flushed, and fully audited                                                     |
| G2-07 | LOCALAPPDATA recovery copy and approved rollback restore without silent overwrite                                                                                         |
| G2-08 | Restart safely reconciles every LOCALAPPDATA write journal state                                                                                                          |
...
- New Yellow/Red capability without recorded operator gate-entry and gate-exit authorization.
