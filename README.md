...
inheritance; failure to copy either stops publication before commit. File
owner, primary group, SACL/audit data, and mandatory integrity labels are
inherited or OS-managed for the replacement file and are outside this public
catalog's threat contract. Generation intentionally does not require the
elevated ownership or security privileges those fields can need, including in
ordinary OneDrive-backed checkouts.
